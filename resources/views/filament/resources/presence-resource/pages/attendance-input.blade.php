<x-filament-panels::page>
    <form wire:submit.prevent="save" class="space-y-6">
        ...
        <div class="flex justify-end items-center gap-3 pt-6">
            ...
            <button type="submit" class="px-4 py-2 text-sm font-medium text-white bg-primary-600 border border-transparent rounded-md hover:bg-primary-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500">Simpan Kehadiran</button>
        </div>
    </form>
</x-filament-panels::page> 